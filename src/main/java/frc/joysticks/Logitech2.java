...
public class Logitech2 extends OI {
    public Logitech2(int port) { super(port); }
    ...
    @Override public boolean button_L2() { return this.getButton(6); }
    ...
    @Override public boolean button_back() { return this.getButton(8); }
